...
Only when the module actually changed: announcing it for a navigation that stays put would strand the module still on screen with no listeners and nothing to reinstall them.
